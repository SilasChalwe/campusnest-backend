...
public interface PropertyRepository extends JpaRepository<Property, Long> {
    ...
    Page<Property> searchProperties(@Param("query") String query,
    ...
    Page<Property> findPropertiesWithinRadius(@Param("lat") Double latitude,
                                              @Param("lng") Double longitude,
                                              @Param("radiusKm") Double radiusKm,
                                              Pageable pageable);

    @Query("SELECT p FROM Property p JOIN p.amenities a WHERE a IN :amenities")
